      ...
      <View style={styles.rightPanel}>
        <View>
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            ...
            <View>
              <TouchableOpacity style={styles.eraseBtnContainer}>
                <FontAwesome6 name="eraser" size={width * 0.015} color={colors.gray4} />
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.instructionBox}>
            <Text style={styles.instructionTitle}>📌 Petunjuk</Text>
            <Text>• Untuk memulai silakan pilih barang disamping atau klik icon 🔍</Text>
            <Text>• Klik icon ⚙️ untuk mengatur gudang dan harga</Text>
            <Text>• Klik nama disebelah icon 👤 untuk mengganti nama customer</Text>
            <Text>• Klik icon 🗑️ untuk menghapus semua barang yang sudah dipilih</Text>
          </View>
        </View>
        <TouchableOpacity style={styles.payButton}>
          <Text style={styles.payButtonText}>Bayar Rp 0</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );

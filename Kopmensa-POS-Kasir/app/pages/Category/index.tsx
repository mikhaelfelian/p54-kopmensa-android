...
const CategoryScreen: React.FC<any> = () => {
  ...
  const renderRow = ({ item }: any) => (
    <View style={styles.tableRow}>
      ...
      <Text style={[styles.cell, { flex: 1.2 }]}>{item.category}</Text>
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.filterBox}>
        ...
        <View style={styles.filterRow}>
          <View style={styles.searchBox}>
            ...
            <Gap width={14} />
            <TextInput style={[labelStyles.normalGray4Label500, styles.centerVerticalText, { flex: 1 }]} placeholder="Masukkan kode atau nama kategori..." value={search} onChangeText={setSearch} />
          </View>
      ...
      <View style={styles.tableHeader}>
        ...
        <Text style={[styles.headerCell, { flex: 1.2 }]}>Kategori</Text>
